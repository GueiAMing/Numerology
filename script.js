...
function getZodiacSign(day, month) {
    if ((month == 3 && day >= 21) || (month == 4 && day <= 20)) return "1(牡羊座)";
    else if ((month == 4 && day >= 21) || (month == 5 && day <= 21)) return "2(金牛座)";
    else if ((month == 5 && day >= 22) || (month == 6 && day <= 21)) return "3(雙子座)";
    else if ((month == 6 && day >= 22) || (month == 7 && day <= 22)) return "4(巨蟹座)";
    else if ((month == 7 && day >= 23) || (month == 8 && day <= 21)) return "5(獅子座)";
    else if ((month == 8 && day >= 22) || (month == 9 && day <= 23)) return "6(處女座)";
    else if ((month == 9 && day >= 24) || (month == 10 && day <= 23)) return "7(天秤座)";
    else if ((month == 10 && day >= 24) || (month == 11 && day <= 22)) return "8(天蠍座)";
    else if ((month == 11 && day >= 23) || (month == 12 && day <= 22)) return "9(射手座)";
    else if ((month == 12 && day >= 23) || (month == 1 && day <= 20)) return "1(10)(摩羯座)";
    else if ((month == 1 && day >= 21) || (month == 2 && day <= 19)) return "2(11)(水瓶座)";
    else if ((month == 2 && day >= 20) || (month == 3 && day <= 20)) return "3(12)(雙魚座)";
}
